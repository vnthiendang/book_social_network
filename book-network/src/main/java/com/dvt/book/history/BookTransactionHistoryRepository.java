...
public interface BookTransactionHistoryRepository extends JpaRepository<BookTransactionHistory, Integer> {
    ...
    @Query("""
            ...
            """)
    Page<BookTransactionHistory> findAllBorrowedBooks(@Param("userId") Pageable pageable, Integer userId);
    @Query("""
            SELECT history
            FROM BookTransactionHistory history
            WHERE history.book.owner.id = :userId
            """)
    Page<BookTransactionHistory> findAllReturnedBooks(@Param("userId") Pageable pageable, Integer userId);
}
